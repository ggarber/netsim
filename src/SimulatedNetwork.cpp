...
using netsim::optional;
using netsim::Config;
using netsim::SimulatedNetwork;
using netsim::PacketDeliveryInfo;
...
void SimulatedNetwork::UpdateConfig(
    std::function<void(Config*)> config_modifier) {
...
optional<int64_t> SimulatedNetwork::NextDeliveryTimeUs() const {
